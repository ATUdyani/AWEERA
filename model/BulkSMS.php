...
class BulkSMS
{
    ...
    function __construct(){
        self::$username = 'aweerateamscorp';
        self::$password = 'aweera123';
        self::$url = 'https://bulksms.vsms.net/eapi/submission/send_sms/2/2.0';
    }
    ...
    function sendAppointmentSuccessSMS($cust_phone,$appointment_date,$start_time,$end_time,$emp_first_name,$emp_last_name,$service_name){
        ...
        try{
            ...
            $unicode_msg = $service_name.", ".$appointment_date
                .", ".$start_time."h to ".$end_time."h, with ".$emp_first_name." - FROM AWEERA";

            $post_body = $this->unicode_sms( self::$username, self::$password, $unicode_msg, $contactno2 );
    ...
    function sendAppointmentCancelSMS($cust_phone,$appointment_date,$start_time,$end_time,$emp_first_name,$emp_last_name,$service_name){
        ...
        try{
            ...
            $unicode_msg = "Cancelled ".$service_name.", ".$appointment_date
                .", at".$start_time."h "."with ".$emp_first_name." - FROM AWEERA";
