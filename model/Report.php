...
class Report{
    ...
    public function setHeaderReceipt($pdf){
        ...
        //Cell(width,height,text,border,endline,[align])
        $pdf->Cell(130 ,12,'',0,1,'C');//end of line

        $pdf->Image('../img/aweera-black.png',43,10,-200);

        $pdf->SetFont('Arial','',11);

        $pdf->Cell(130 ,10,'No. 220, Solomon Peiris Avenue, Mount Lavinia ',0,1,'C');//end of line

        $pdf->Cell(130 ,0,'+94 11 2 727285 ',0,1,'C');//end of line

        $pdf->SetFont('Arial','B',20);

        $pdf->Cell(130 ,10,'',0,1,'C');//end of line
        $pdf->Cell(130 ,10,'',0,1,'C');//end of line
    }
