...
<form class="userform" method="post" id="staff_form">
	<div class="form-group row">
	  ...
	  <div class="col-md-8">
	    <input class="form-control" type="text"  id="first_name" maxlength="50" required="">
	  </div>
	</div>
	...
	<div class="form-group row">
	  ...
	  <div class="col-md-8">
	    <input class="form-control" type="text"  id="last_name" maxlength="50" required="">
	  </div>
	</div>
	...
	<div class="form-group row">
	  ...
	  <div class="col-md-8">
	    <input class="form-control" type="email"  id="emp_email" maxlength="50" required="">
	  </div>
	</div>
	...
	<div class="form-group row">
	  ...
	  <div class="col-md-8">
	    <input class="form-control" type="tel" id="emp_phone" maxlength="10" required="">
	  </div>
	</div>
